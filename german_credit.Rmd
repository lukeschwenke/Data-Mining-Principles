...
## This tells us that when we repeat the model 1,000 times, the confidence in the best coefficients for each indepdent variable has increased (the range of our confidence intervals are smaller). Intuitively this makes sense because instead of just running 1 model and trying to discover the best coefficients, we have now done this 1,000 times and taken averages to make this determination. If we were to sample 10,000 times, the confidence intervals would be even tigheter

```{r Review Means, echo=TRUE, warning=FALSE}
